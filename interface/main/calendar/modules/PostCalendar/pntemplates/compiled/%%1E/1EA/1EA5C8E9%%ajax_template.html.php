<?php /* Smarty version 2.6.31, created on 2018-09-11 08:06:01
         compiled from default/views/day/ajax_template.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'default/views/day/ajax_template.html', 10, false),array('function', 'pc_sort_events', 'default/views/day/ajax_template.html', 396, false),array('modifier', 'date_format', 'default/views/day/ajax_template.html', 391, false),array('modifier', 'string_format', 'default/views/day/ajax_template.html', 392, false),)), $this); ?>
...
echo "   <a id='prevday' href='$PREV_DAY_URL' onclick='top.restoreSession()' title='" . xl("Previous Day") . "'>
            <i class='fa ".$chevron_icon_left." chevron_color' aria-hidden='true'></i></a>\n";
...
echo "   <a id='nextday' href='$NEXT_DAY_URL' onclick='top.restoreSession()' title='" . xl("Next Day") . "'>
            <i class= 'fa ".$chevron_icon_right." chevron_color' aria-hidden='true'></i></a>\n";
 ?>
</div>
